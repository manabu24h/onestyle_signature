			...
			<section class="pl-unit ">
				...
				<ul>
					<li class="item">
						...
						<p class="detail">和装については、以下の和装カタログからセレクトして頂きます。セレクトして頂く衣装によって、追加料金が発生するものがございますのでご注意くださいませ。<br />なお、横浜店の衣装をセレクトされた場合、お取り寄せ料金が別途1万円発生致します。</p>
					</li>
					<li class="item">
						<div class="thumb">
							<a href="">
			...
			<section class="pl-unit ">
				...
				<ul class="clmn-1">
					<li class="item clearfix">
						...
						<p class="detail"><span class="label">和装は、和装カタログからセレクトして頂きます。</span><br />セレクトして頂く衣装によって、追加料金が発生するものがございますので、ご注意くださいませ。<br />東京のロケーションフォトのお客様は表参道店の衣装から、横浜のロケーションフォトのお客様は横浜店の衣装からセレクトして頂きますが、他店舗の衣装でもお取り寄せ可能です。（お取り寄せ料金1万円）<br />なお、それぞれの店舗の衣装を実際にご覧になりたい場合、お袖を通すなどをお試しになりたい場合は平日のみ、ご予約をもって対応させて頂いております。（予約がない場合はご案内できません）</p>
					</li>
				</ul>
				...
				<ul class="clmn-1" style="padding-top: 32px;">
					<li class="item clearfix">
						...
						<p class="detail"><span class="label">洋装については、事前のご試着を行って頂いております。</span><br /><span class="cl-f00">なお、衣装のご試着についてはONESTYLE表参道店のみのご案内となっております。</span><br />セレクトして頂く衣装によって、追加料金が発生するものがございますので、ご注意くださいませ。事前のご来店が難しい場合には、撮影日当日のご試着も可能でございます。ただし、サイズ感が合わないなどの理由で撮影キャンセルを承ることはできません。原則、事前のご試着をお願いしております。</p>
					</li>
				</ul>
